...
$('.add_to_cart').click(function () {
    ...
    var productPrice = parseFloat($('.product_price:first .price').text());
    ...
    setTimeout(function () {
        ...
        var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + productImage + "' alt='' /></div><span>" + productName + "</span><strong>Ksh" + productPrice.toFixed(2) + "</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";
        ...
        $("#cart .cart-item").last()
            .addClass("flash")
            .find(".delete-item").click(function () {
                // Subtract deleted product price from total cost
                totalCost -= productPrice;
        ...
        // Update total cost in the summary
